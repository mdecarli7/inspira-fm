/* ============================================================
   ...
   Uso:  <canvas class="bloom" data-color="#82DD47" ...></canvas>
   ...
   Parâmetros por data-attribute (todos opcionais):
     ...
     data-opacity            opacidade do canvas inteiro (0–1)
     data-speed              multiplicador geral de velocidade
     data-grid               densidade da grade (maior = mais células)
     data-rotation           velocidade da rotação lenta
     data-fade               queda da vinheta (menor = fade mais duro)
     data-distortion         distorção orgânica das linhas (0 = reto)
     data-flow-x/-flow-y     deriva horizontal/vertical
     data-hover-light        raio da luz sob o mouse
     data-hover-radius       raio do empurrão geométrico
...
(function () {
  ...
  var FRAG = [
    ...
    // mouse (distância no espaço de tela não rotacionado)
    ...
    // lente do mouse (empurra a grade)
    ...
    // orbes de brilho em cruzamentos sorteados
  ...
  function Bloom(canvas) {
    ...
    var u = {};
    ['iTime', 'iResolution', 'iMouse', 'uMouseActive', 'uColor', 'uSpeed', 'uGridScale',
     'uRotationSpeed', 'uFadeFalloff', 'uDistortionAmount', 'uFlowSpeedX', 'uFlowSpeedY',
     'uHoverRepulsionRadius', 'uHoverRepulsionStrength', 'uHoverLightRadius'
    ...
    gl.uniform1f(u.uGridScale, num(d.grid, 12.0));
    gl.uniform1f(u.uRotationSpeed, num(d.rotation, 0.0));
    gl.uniform1f(u.uFadeFalloff, num(d.fade, 10.0));
    gl.uniform1f(u.uDistortionAmount, num(d.distortion, 0.05));
    gl.uniform1f(u.uFlowSpeedX, num(d.flowX, -0.2));
    gl.uniform1f(u.uFlowSpeedY, num(d.flowY, -0.4));
    gl.uniform1f(u.uHoverLightRadius, num(d.hoverLight, 0.5));
    gl.uniform1f(u.uHoverRepulsionRadius, num(d.hoverRadius, 1.0));
