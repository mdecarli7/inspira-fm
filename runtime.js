...
var JR_MODELOS = {
  "embaixador": {
    "nome": "Contrato de embaixador(a) — coluna de rádio",
    "titulo": "Contrato de Prestação de Serviços — Embaixador(a)",
    "tipo": "Contrato",
    "partes": "Inspira FM — Campinas × [EMBAIXADOR(A) / PRODUTORA]",
    "texto": "CONTRATANTE: LIFE COMUNICAÇÃO LTDA. — INSPIRA FM — CAMPINAS, pessoa jurídica de direito privado com endereço na Rua Atibaia, nº 26, Nova Campinas, Campinas/SP, CEP 13.092-142, inscrita no CNPJ sob nº 53.090.596/0001-24, neste ato representada na forma de seu contrato social, adiante denominada simplesmente CONTRATANTE.\n\nCONTRATADA: [RAZÃO SOCIAL DA PRODUTORA], pessoa jurídica de direito privado com endereço na [ENDEREÇO], CEP [CEP], inscrita no CNPJ/MF sob nº [CNPJ], neste ato representada na forma de seu contrato social, adiante denominada simplesmente CONTRATADA; e\n\nANUENTE: [NOME COMPLETO], residente e domiciliado(a) na [ENDEREÇO], CEP [CEP], inscrito(a) no CPF sob o nº [CPF], adiante denominado(a) simplesmente ANUENTE.\n\nObservação: caso o(a) embaixador(a) não possua pessoa jurídica, suprimir a CONTRATADA e tratá-lo(a) diretamente como parte CONTRATADA (pessoa física), mantidas as demais cláusulas.\n\nCLÁUSULA PRIMEIRA — DO OBJETO\n1.1. O objeto deste instrumento é a prestação, pela CONTRATADA à CONTRATANTE, por sua representada — a ANUENTE, dos serviços de criação, edição, produção, locução, gravação, montagem e finalização de coluna/boletim de rádio sobre [TEMA — ex.: cinema, esporte, finanças, bem-estar] e afins, intitulada \"[NOME DA COLUNA]\".\n1.1.1. A coluna/boletim será veiculada pela CONTRATANTE na grade de programação da emissora INSPIRA FM — CAMPINAS, em uma edição diária, com duração aproximada de 1 (um) a 2 (dois) minutos, exclusivamente para a cidade de Campinas, conforme acordado entre as partes.\n1.1.2. A CONTRATADA e a ANUENTE poderão participar de ações promocionais externas da CONTRATANTE, para divulgação da coluna, devendo tais participações ser prévia e expressamente acordadas entre as partes, especialmente quanto a valores, datas, horários e locais.\n1.2. O nome/marca \"[NOME DA COLUNA]\" é de titularidade exclusiva da ANUENTE, sendo vedado à CONTRATANTE qualquer uso que não esteja vinculado exclusivamente à coluna objeto deste instrumento.\n1.3. A CONTRATANTE reconhece que a marca é e continuará sendo de propriedade exclusiva da ANUENTE.\n1.4. A CONTRATANTE não registrará nem tentará registrar, em qualquer local, marca, nome comercial, logomarca ou expressão idêntica ou similar à marca.\n\nCLÁUSULA SEGUNDA — DO PRAZO\n2.1. A prestação dos serviços terá início em [DATA DE INÍCIO] e término em [DATA DE TÉRMINO].\n2.2. Após o prazo inicial de 6 (seis) meses de vigência, contado da assinatura, caso não tenha ocorrido venda de patrocínio por parte da CONTRATANTE, as partes negociarão um valor fixo mensal para continuidade da veiculação do boletim.\n\nCLÁUSULA TERCEIRA — DO PREÇO E PAGAMENTO\n3.1. Pela prestação dos serviços, a CONTRATANTE pagará à parte CONTRATADA os percentuais abaixo, incidentes sobre a receita líquida de qualquer cota de patrocínio vendida para a coluna/boletim:\na) 20% (vinte por cento) — quando o cliente/anunciante do patrocínio for captado no mercado pela CONTRATANTE; e\nb) 30% (trinta por cento) — quando o cliente/anunciante for captado no mercado pela parte CONTRATADA.\n3.2. Os pagamentos serão efetuados em até 5 (cinco) dias após o recebimento dos valores do patrocínio pela CONTRATANTE, sob pena de juros de mora de 1% (um por cento) ao mês e multa moratória de 2% (dois por cento).\n3.3. A parte CONTRATADA manterá contato permanente com a Área Comercial da CONTRATANTE, a fim de evitar desencontro de informações e prática de valores distintos perante clientes, anunciantes ou agências de publicidade.\n\nCLÁUSULA QUARTA — DA RESCISÃO\n4.1. O presente contrato poderá ser rescindido de pleno direito, por qualquer das partes, independentemente de notificação judicial ou extrajudicial, sem prejuízo das sanções legais cabíveis, nas seguintes hipóteses:\na) descumprimento, por qualquer das partes, de obrigação assumida neste instrumento; e\nb) falência requerida, recuperação judicial ou insolvência de qualquer das partes, de qualquer modo declarada ou reconhecida.\nIndependentemente das hipóteses acima, qualquer das partes poderá rescindir este contrato, sem ônus, mediante notificação formal enviada com antecedência mínima de 30 (trinta) dias.\n\nCLÁUSULA QUINTA — DAS DISPOSIÇÕES GERAIS\n5.1. Este contrato, e as obrigações e direitos dele decorrentes, não poderá ser cedido ou transferido a terceiros sem a prévia, expressa e escrita anuência da outra parte.\n5.2. As partes têm plenos poderes e capacidade para celebrar este instrumento e desempenhar as obrigações aqui estabelecidas.\n5.3. Os termos deste contrato somente poderão ser modificados por Termo Aditivo assinado por ambas as partes.\n5.4. Fica eleito o foro da Comarca de [FORO — ex.: Campinas/SP] para dirimir controvérsias oriundas deste contrato, com renúncia a qualquer outro, por mais privilegiado que seja.\n\nE, por estarem justas e contratadas, as partes assinam o presente instrumento em 02 (duas) vias de igual teor e forma, na presença das testemunhas que também o assinam.\n\n[CIDADE/UF], [DATA].\n\n\n_____________________________________\nLIFE COMUNICAÇÃO LTDA. — INSPIRA FM — CAMPINAS\nCONTRATANTE\n\n_____________________________________\n[RAZÃO SOCIAL DA PRODUTORA] — CONTRATADA\n\n_____________________________________\n[NOME COMPLETO] — ANUENTE\n\nTestemunhas:\n\n1. _____________________________   Nome / CPF:\n\n2. _____________________________   Nome / CPF:"
  },
  "colunista": {
    "nome": "Contrato de colunista do site",
    "titulo": "Contrato de Prestação de Serviços — Colunista",
    "tipo": "Contrato",
    "partes": "Inspira FM — Campinas × [COLUNISTA]",
    "texto": "CONTRATANTE: LIFE COMUNICAÇÃO LTDA. — INSPIRA FM — CAMPINAS, pessoa jurídica de direito privado com endereço na Rua Atibaia, nº 26, Nova Campinas, Campinas/SP, CEP 13.092-142, inscrita no CNPJ sob nº 53.090.596/0001-24, neste ato representada na forma de seu contrato social, adiante denominada simplesmente CONTRATANTE.\n\nCONTRATADO(A): [NOME COMPLETO / RAZÃO SOCIAL], inscrito(a) no CPF/CNPJ sob nº [DOCUMENTO], residente/sediado(a) na [ENDEREÇO], CEP [CEP], adiante denominado(a) simplesmente COLUNISTA.\n\nCLÁUSULA PRIMEIRA — DO OBJETO\n1.1. Prestação, pelo(a) COLUNISTA, dos serviços de criação, redação, produção e finalização da coluna intitulada \"[NOME DA COLUNA]\", sobre [TEMA], para publicação no site e nos canais digitais da INSPIRA FM — CAMPINAS.\n1.1.1. A coluna será publicada com frequência [FREQUÊNCIA — ex.: semanal, quinzenal], preferencialmente [DIA — ex.: toda quarta-feira], em formato [TEXTO / VÍDEO / ÁUDIO], conforme acordado entre as partes.\n1.1.2. Caso a coluna também venha a ser veiculada na rádio: A coluna/boletim será veiculada pela CONTRATANTE na grade de programação da emissora INSPIRA FM — CAMPINAS, em uma edição diária, com duração aproximada de 1 (um) a 2 (dois) minutos, exclusivamente para a cidade de Campinas, conforme acordado entre as partes.\n1.1.3. O(A) COLUNISTA poderá participar de ações promocionais da CONTRATANTE, mediante acordo prévio quanto a valores, datas, horários e locais.\n1.2. O nome/marca \"[NOME DA COLUNA]\", quando de criação do(a) COLUNISTA, permanece de sua titularidade exclusiva, vedado à CONTRATANTE uso dissociado da coluna objeto deste instrumento.\n\nCLÁUSULA SEGUNDA — DO PRAZO\n2.1. Início em [DATA DE INÍCIO] e término em [DATA DE TÉRMINO].\n\nCLÁUSULA TERCEIRA — DO PREÇO E PAGAMENTO\n3.1. Pela prestação dos serviços, a CONTRATANTE pagará ao(à) COLUNISTA, conforme a opção assinalada:\nOpção A — valor fixo mensal de R$ [VALOR] ([VALOR POR EXTENSO]), pago até o dia [DIA] de cada mês, mediante [FORMA DE PAGAMENTO]; ou\nOpção B — percentual sobre a receita líquida de patrocínio da coluna, sendo 20% (vinte por cento) quando o anunciante for captado pela CONTRATANTE e 30% (trinta por cento) quando captado pelo(a) COLUNISTA.\n3.2. Nos casos de patrocínio, os pagamentos serão efetuados em até 5 (cinco) dias após o recebimento dos valores do patrocínio pela CONTRATANTE, sob pena de juros de mora de 1% (um por cento) ao mês e multa moratória de 2% (dois por cento).\n3.3. A parte CONTRATADA manterá contato permanente com a Área Comercial da CONTRATANTE, a fim de evitar desencontro de informações e prática de valores distintos perante clientes, anunciantes ou agências de publicidade.\n\nCLÁUSULA QUARTA — DA RESCISÃO\n4.1. O presente contrato poderá ser rescindido de pleno direito, por qualquer das partes, independentemente de notificação judicial ou extrajudicial, sem prejuízo das sanções legais cabíveis, nas seguintes hipóteses:\na) descumprimento, por qualquer das partes, de obrigação assumida neste instrumento; e\nb) falência requerida, recuperação judicial ou insolvência de qualquer das partes, de qualquer modo declarada ou reconhecida.\nIndependentemente das hipóteses acima, qualquer das partes poderá rescindir este contrato, sem ônus, mediante notificação formal enviada com antecedência mínima de 30 (trinta) dias.\n\nCLÁUSULA QUINTA — DAS DISPOSIÇÕES GERAIS\n5.1. As matérias produzidas para o site poderão ser mantidas no acervo digital da CONTRATANTE mesmo após o término da vigência, ressalvada a marca própria do(a) COLUNISTA.\n5.2. Este contrato, e as obrigações e direitos dele decorrentes, não poderá ser cedido ou transferido a terceiros sem a prévia, expressa e escrita anuência da outra parte.\n5.3. As partes têm plenos poderes e capacidade para celebrar este instrumento e desempenhar as obrigações aqui estabelecidas.\n5.4. Os termos deste contrato somente poderão ser modificados por Termo Aditivo assinado por ambas as partes.\n5.5. Fica eleito o foro da Comarca de [FORO — ex.: Campinas/SP] para dirimir controvérsias oriundas deste contrato, com renúncia a qualquer outro, por mais privilegiado que seja.\n\nE, por estarem justas e contratadas, as partes assinam o presente instrumento em 02 (duas) vias de igual teor e forma, na presença das testemunhas que também o assinam.\n\n[CIDADE/UF], [DATA].\n\n\n_____________________________________\nLIFE COMUNICAÇÃO LTDA. — INSPIRA FM — CAMPINAS\nCONTRATANTE\n\n_____________________________________\n[NOME COMPLETO / RAZÃO SOCIAL] — COLUNISTA\n\nTestemunhas:\n\n1. _____________________________   Nome / CPF:\n\n2. _____________________________   Nome / CPF:"
  },
  "influenciador": {
    "nome": "Contrato de influenciador(a) / creator",
    "titulo": "Contrato de Prestação de Serviços — Influenciador(a)",
    "tipo": "Contrato",
    "partes": "Inspira FM — Campinas × [INFLUENCIADOR(A)]",
    "texto": "CONTRATANTE: LIFE COMUNICAÇÃO LTDA. — INSPIRA FM — CAMPINAS, pessoa jurídica de direito privado com endereço na Rua Atibaia, nº 26, Nova Campinas, Campinas/SP, CEP 13.092-142, inscrita no CNPJ sob nº 53.090.596/0001-24, neste ato representada na forma de seu contrato social, adiante denominada simplesmente CONTRATANTE.\n\nCONTRATADO(A): [NOME COMPLETO / RAZÃO SOCIAL], inscrito(a) no CPF/CNPJ sob nº [DOCUMENTO], residente/sediado(a) na [ENDEREÇO], titular do perfil [@PERFIL] na plataforma [PLATAFORMA], adiante denominado(a) simplesmente INFLUENCIADOR(A).\n\nCLÁUSULA PRIMEIRA — DO OBJETO\n1.1. Prestação, pelo(a) INFLUENCIADOR(A), de serviços de criação e publicação de conteúdo para divulgação da INSPIRA FM — CAMPINAS e/ou de seus anunciantes.\n1.1.1. As entregas do período compreendem: [DESCREVER — ex.: X publicações no feed, Y stories e Z reels por mês], nas plataformas [LISTAR], observados os direcionamentos de pauta acordados com a CONTRATANTE.\n1.1.2. O conteúdo poderá mencionar e marcar os perfis oficiais da CONTRATANTE e utilizar as hashtags e materiais por ela fornecidos.\n1.1.3. Ações presenciais (eventos, coberturas) serão previamente acordadas quanto a valores, datas, horários e locais.\n1.2. Quando exigida aprovação prévia do conteúdo pela CONTRATANTE, esta observará o prazo de [X] dias antes da publicação.\n\nCLÁUSULA SEGUNDA — DO PRAZO\n2.1. Início em [DATA DE INÍCIO] e término em [DATA DE TÉRMINO], ou por campanha, conforme Anexo.\n\nCLÁUSULA TERCEIRA — DO PREÇO E PAGAMENTO\n3.1. A CONTRATANTE remunerará o(a) INFLUENCIADOR(A) conforme a opção assinalada:\nOpção A — valor fixo de R$ [VALOR] por [MÊS / CAMPANHA / ENTREGA];\nOpção B — permuta, mediante as contrapartidas de mídia descritas no Anexo; ou\nOpção C — percentual sobre patrocínio captado, sendo 20% (captação da CONTRATANTE) e 30% (captação do(a) INFLUENCIADOR(A)).\n3.2. Os pagamentos serão efetuados em até 5 (cinco) dias após [o recebimento do patrocínio / a entrega aprovada], sob pena de juros de mora de 1% ao mês e multa de 2%.\n3.3. Os direitos de imagem e sobre o conteúdo produzido ficam licenciados à CONTRATANTE para uso em seus canais durante a vigência e por [PRAZO] após o término.\n\nCLÁUSULA QUARTA — DA RESCISÃO\n4.1. O presente contrato poderá ser rescindido de pleno direito, por qualquer das partes, independentemente de notificação judicial ou extrajudicial, sem prejuízo das sanções legais cabíveis, nas seguintes hipóteses:\na) descumprimento, por qualquer das partes, de obrigação assumida neste instrumento; e\nb) falência requerida, recuperação judicial ou insolvência de qualquer das partes, de qualquer modo declarada ou reconhecida.\nIndependentemente das hipóteses acima, qualquer das partes poderá rescindir este contrato, sem ônus, mediante notificação formal enviada com antecedência mínima de 30 (trinta) dias.\n\nCLÁUSULA QUINTA — DAS DISPOSIÇÕES GERAIS\n5.1. Exclusividade: durante a vigência, o(a) INFLUENCIADOR(A) [atuará / não atuará] para veículos de rádio concorrentes na região de Campinas, conforme assinalado.\n5.2. Este contrato, e as obrigações e direitos dele decorrentes, não poderá ser cedido ou transferido a terceiros sem a prévia, expressa e escrita anuência da outra parte.\n5.3. As partes têm plenos poderes e capacidade para celebrar este instrumento e desempenhar as obrigações aqui estabelecidas.\n5.4. Os termos deste contrato somente poderão ser modificados por Termo Aditivo assinado por ambas as partes.\n5.5. Fica eleito o foro da Comarca de [FORO — ex.: Campinas/SP] para dirimir controvérsias oriundas deste contrato, com renúncia a qualquer outro, por mais privilegiado que seja.\n\nE, por estarem justas e contratadas, as partes assinam o presente instrumento em 02 (duas) vias de igual teor e forma, na presença das testemunhas que também o assinam.\n\n[CIDADE/UF], [DATA].\n\n\n_____________________________________\nLIFE COMUNICAÇÃO LTDA. — INSPIRA FM — CAMPINAS\nCONTRATANTE\n\n_____________________________________\n[NOME COMPLETO / RAZÃO SOCIAL] — INFLUENCIADOR(A)\n\nTestemunhas:\n\n1. _____________________________   Nome / CPF:\n\n2. _____________________________   Nome / CPF:"
  },
  "equipe": {
    "nome": "Contrato da equipe (diretoria à operação)",
    "titulo": "Contrato de Prestação de Serviços — Equipe",
    "tipo": "Contrato",
    "partes": "Inspira FM — Campinas × [INTEGRANTE DA EQUIPE]",
    "texto": "CONTRATANTE: LIFE COMUNICAÇÃO LTDA. — INSPIRA FM — CAMPINAS, pessoa jurídica de direito privado com endereço na Rua Atibaia, nº 26, Nova Campinas, Campinas/SP, CEP 13.092-142, inscrita no CNPJ sob nº 53.090.596/0001-24, neste ato representada na forma de seu contrato social, adiante denominada simplesmente CONTRATANTE.\n\nCONTRATADO(A): [NOME COMPLETO / RAZÃO SOCIAL], inscrito(a) no CPF/CNPJ sob nº [DOCUMENTO], residente/sediado(a) na [ENDEREÇO], adiante denominado(a) simplesmente CONTRATADO(A), para a função de [CARGO — ex.: Diretor(a) de Marketing, Coordenador(a), Analista, Locutor(a), Produtor(a)].\n\nEste modelo aplica-se a todos os integrantes do organograma, da diretoria à operação, e também a prestadores externos.\n\nCLÁUSULA PRIMEIRA — DO OBJETO\n1.1. Prestação dos serviços inerentes à função de [CARGO], compreendendo [DESCREVER AS PRINCIPAIS ATRIBUIÇÕES], com dedicação [INTEGRAL / PARCIAL] e carga de [X] horas semanais.\n1.2. Os serviços serão prestados [presencialmente na sede / remotamente / em regime híbrido], observadas as diretrizes e o cronograma da CONTRATANTE.\n\nCLÁUSULA SEGUNDA — DO PRAZO\n2.1. Vigência por prazo [INDETERMINADO / DETERMINADO, de [DATA] a [DATA]].\n\nCLÁUSULA TERCEIRA — DA REMUNERAÇÃO\n3.1. A CONTRATANTE pagará ao(à) CONTRATADO(A) o valor mensal de R$ [VALOR] ([VALOR POR EXTENSO]), até o dia [DIA] de cada mês, mediante [FORMA DE PAGAMENTO].\n3.2. Eventual remuneração variável (comissões, metas ou bonificações) e reajustes serão tratados em Anexo ou instrumento próprio.\n\nCLÁUSULA QUARTA — DA NATUREZA DA RELAÇÃO\n4.1. Conforme a modalidade assinalada: [este contrato não gera vínculo empregatício, executando o(a) CONTRATADO(A) os serviços com autonomia e arcando com suas obrigações fiscais e previdenciárias] OU [a relação rege-se pela CLT, com registro em CTPS e os direitos trabalhistas correspondentes].\n\nCLÁUSULA QUINTA — DA CONFIDENCIALIDADE E DA PROPRIEDADE\n5.1. O(A) CONTRATADO(A) manterá sigilo sobre informações internas da CONTRATANTE — comerciais, financeiras, de audiência e de programação — a que tiver acesso, durante e após a vigência.\n5.2. Todo material, obra ou dado produzido no exercício da função pertence à CONTRATANTE, que poderá utilizá-lo livremente em seus canais.\n\nCLÁUSULA SEXTA — DA RESCISÃO\n6.1. O presente contrato poderá ser rescindido de pleno direito, por qualquer das partes, independentemente de notificação judicial ou extrajudicial, sem prejuízo das sanções legais cabíveis, nas seguintes hipóteses:\na) descumprimento, por qualquer das partes, de obrigação assumida neste instrumento; e\nb) falência requerida, recuperação judicial ou insolvência de qualquer das partes, de qualquer modo declarada ou reconhecida.\nIndependentemente das hipóteses acima, qualquer das partes poderá rescindir este contrato, sem ônus, mediante notificação formal enviada com antecedência mínima de 30 (trinta) dias.\n\nCLÁUSULA SÉTIMA — DAS DISPOSIÇÕES GERAIS\n7.1. Este contrato, e as obrigações e direitos dele decorrentes, não poderá ser cedido ou transferido a terceiros sem a prévia, expressa e escrita anuência da outra parte.\n7.2. As partes têm plenos poderes e capacidade para celebrar este instrumento e desempenhar as obrigações aqui estabelecidas.\n7.3. Os termos deste contrato somente poderão ser modificados por Termo Aditivo assinado por ambas as partes.\n7.4. Fica eleito o foro da Comarca de [FORO — ex.: Campinas/SP] para dirimir controvérsias oriundas deste contrato, com renúncia a qualquer outro, por mais privilegiado que seja.\n\nE, por estarem justas e contratadas, as partes assinam o presente instrumento em 02 (duas) vias de igual teor e forma, na presença das testemunhas que também o assinam.\n\n[CIDADE/UF], [DATA].\n\n\n_____________________________________\nLIFE COMUNICAÇÃO LTDA. — INSPIRA FM — CAMPINAS\nCONTRATANTE\n\n_____________________________________\n[NOME COMPLETO / RAZÃO SOCIAL] — CONTRATADO(A)\n\nTestemunhas:\n\n1. _____________________________   Nome / CPF:\n\n2. _____________________________   Nome / CPF:"
  },
  "patrocinio": {
    "nome": "Contrato de patrocínio / veiculação",
    "titulo": "Contrato de Patrocínio e Veiculação Publicitária",
    "tipo": "Contrato",
    "partes": "Inspira FM — Campinas × [PATROCINADORA]",
    "texto": "CONTRATANTE: LIFE COMUNICAÇÃO LTDA. — INSPIRA FM — CAMPINAS, pessoa jurídica de direito privado com endereço na Rua Atibaia, nº 26, Nova Campinas, Campinas/SP, CEP 13.092-142, inscrita no CNPJ sob nº 53.090.596/0001-24, neste ato representada na forma de seu contrato social, adiante denominada simplesmente CONTRATANTE.\n\nPATROCINADORA: [RAZÃO SOCIAL], inscrita no CNPJ sob nº [CNPJ], com sede na [ENDEREÇO], neste ato representada por [NOME DO REPRESENTANTE], adiante denominada simplesmente PATROCINADORA.\n\nCLÁUSULA PRIMEIRA — DO OBJETO\n1.1. Veiculação de [QUANTIDADE] inserções publicitárias de [DURAÇÃO] segundos na programação da CONTRATANTE, no período e nos horários da Cláusula Terceira, além das contrapartidas descritas no plano comercial apresentado à PATROCINADORA.\n\nCLÁUSULA SEGUNDA — DO VALOR E DO PAGAMENTO\n2.1. Pelo patrocínio, a PATROCINADORA pagará à CONTRATANTE o valor mensal de R$ [VALOR] ([VALOR POR EXTENSO]), com vencimento todo dia [DIA] de cada mês, mediante [FORMA DE PAGAMENTO].\n2.2. O atraso superior a [X] dias implicará multa de 2% (dois por cento), juros de 1% (um por cento) ao mês e suspensão das veiculações até a regularização.\n\nCLÁUSULA TERCEIRA — DO PERÍODO E DOS HORÁRIOS\n3.1. Vigência de [DATA DE INÍCIO] a [DATA DE TÉRMINO], com inserções distribuídas [DESCREVER — ex.: de segunda a sexta, entre 7h e 19h].\n\nCLÁUSULA QUARTA — DO MATERIAL PUBLICITÁRIO\n4.1. O material será produzido por [RESPONSÁVEL PELA PRODUÇÃO] e deverá respeitar a legislação vigente e as normas internas da CONTRATANTE, que poderá recusar peça em desacordo.\n\nCLÁUSULA QUINTA — DAS OBRIGAÇÕES DAS PARTES\n5.1. Cabe à CONTRATANTE veicular as inserções contratadas, comunicar alterações relevantes de programação e disponibilizar comprovante de veiculação quando solicitado.\n5.2. Cabe à PATROCINADORA fornecer informações e materiais, efetuar os pagamentos nos prazos e responsabilizar-se pela veracidade das informações comerciais fornecidas.\n\nCLÁUSULA SEXTA — DA RESCISÃO\n6.1. O presente contrato poderá ser rescindido de pleno direito, por qualquer das partes, independentemente de notificação judicial ou extrajudicial, sem prejuízo das sanções legais cabíveis, nas seguintes hipóteses:\na) descumprimento, por qualquer das partes, de obrigação assumida neste instrumento; e\nb) falência requerida, recuperação judicial ou insolvência de qualquer das partes, de qualquer modo declarada ou reconhecida.\nIndependentemente das hipóteses acima, qualquer das partes poderá rescindir este contrato, sem ônus, mediante notificação formal enviada com antecedência mínima de 30 (trinta) dias.\n\nCLÁUSULA SÉTIMA — DAS DISPOSIÇÕES GERAIS\n7.1. Este contrato, e as obrigações e direitos dele decorrentes, não poderá ser cedido ou transferido a terceiros sem a prévia, expressa e escrita anuência da outra parte.\n7.2. As partes têm plenos poderes e capacidade para celebrar este instrumento e desempenhar as obrigações aqui estabelecidas.\n7.3. Os termos deste contrato somente poderão ser modificados por Termo Aditivo assinado por ambas as partes.\n7.4. Fica eleito o foro da Comarca de [FORO — ex.: Campinas/SP] para dirimir controvérsias oriundas deste contrato, com renúncia a qualquer outro, por mais privilegiado que seja.\n\nE, por estarem justas e contratadas, as partes assinam o presente instrumento em 02 (duas) vias de igual teor e forma, na presença das testemunhas que também o assinam.\n\n[CIDADE/UF], [DATA].\n\n\n_____________________________________\nLIFE COMUNICAÇÃO LTDA. — INSPIRA FM — CAMPINAS\nCONTRATANTE\n\n_____________________________________\n[RAZÃO SOCIAL] — PATROCINADORA\n\nTestemunhas:\n\n1. _____________________________   Nome / CPF:\n\n2. _____________________________   Nome / CPF:"
  },
  "permuta": {
    "nome": "Contrato de permuta",
    "titulo": "Contrato de Permuta de Serviços e Mídia",
    "tipo": "Contrato",
    "partes": "Inspira FM — Campinas × [PARCEIRA]",
    "texto": "CONTRATANTE: LIFE COMUNICAÇÃO LTDA. — INSPIRA FM — CAMPINAS, pessoa jurídica de direito privado com endereço na Rua Atibaia, nº 26, Nova Campinas, Campinas/SP, CEP 13.092-142, inscrita no CNPJ sob nº 53.090.596/0001-24, neste ato representada na forma de seu contrato social, adiante denominada simplesmente CONTRATANTE.\n\nPARCEIRA: [RAZÃO SOCIAL], inscrita no CNPJ sob nº [CNPJ], com sede na [ENDEREÇO], adiante denominada simplesmente PARCEIRA.\n\nCLÁUSULA PRIMEIRA — DO OBJETO\n1.1. Permuta entre as partes, sem envolvimento de valores em dinheiro: a CONTRATANTE fornecerá [DESCREVER A MÍDIA — ex.: X inserções semanais de 30 segundos e menções nas redes sociais] e a PARCEIRA fornecerá [DESCREVER PRODUTOS / SERVIÇOS].\n\nCLÁUSULA SEGUNDA — DA VALORAÇÃO\n2.1. Para fins de equivalência e registro, as partes atribuem à permuta o valor mensal de referência de R$ [VALOR].\n\nCLÁUSULA TERCEIRA — DA VIGÊNCIA\n3.1. De [DATA DE INÍCIO] a [DATA DE TÉRMINO], renovável por acordo escrito entre as partes.\n\nCLÁUSULA QUARTA — DAS RESPONSABILIDADES\n4.1. Cada parte responde pela qualidade e entrega daquilo que fornece, mantendo o padrão combinado durante toda a vigência.\n\nCLÁUSULA QUINTA — DA RESCISÃO\n5.1. O presente contrato poderá ser rescindido de pleno direito, por qualquer das partes, independentemente de notificação judicial ou extrajudicial, sem prejuízo das sanções legais cabíveis, nas seguintes hipóteses:\na) descumprimento, por qualquer das partes, de obrigação assumida neste instrumento; e\nb) falência requerida, recuperação judicial ou insolvência de qualquer das partes, de qualquer modo declarada ou reconhecida.\nIndependentemente das hipóteses acima, qualquer das partes poderá rescindir este contrato, sem ônus, mediante notificação formal enviada com antecedência mínima de 30 (trinta) dias.\n\nCLÁUSULA SEXTA — DAS DISPOSIÇÕES GERAIS\n6.1. Este contrato, e as obrigações e direitos dele decorrentes, não poderá ser cedido ou transferido a terceiros sem a prévia, expressa e escrita anuência da outra parte.\n6.2. As partes têm plenos poderes e capacidade para celebrar este instrumento e desempenhar as obrigações aqui estabelecidas.\n6.3. Os termos deste contrato somente poderão ser modificados por Termo Aditivo assinado por ambas as partes.\n6.4. Fica eleito o foro da Comarca de [FORO — ex.: Campinas/SP] para dirimir controvérsias oriundas deste contrato, com renúncia a qualquer outro, por mais privilegiado que seja.\n\nE, por estarem justas e contratadas, as partes assinam o presente instrumento em 02 (duas) vias de igual teor e forma, na presença das testemunhas que também o assinam.\n\n[CIDADE/UF], [DATA].\n\n\n_____________________________________\nLIFE COMUNICAÇÃO LTDA. — INSPIRA FM — CAMPINAS\nCONTRATANTE\n\n_____________________________________\n[RAZÃO SOCIAL] — PARCEIRA\n\nTestemunhas:\n\n1. _____________________________   Nome / CPF:\n\n2. _____________________________   Nome / CPF:"
  },
  "imagem": {
    "nome": "Termo de uso de imagem e voz",
    "titulo": "Termo de Autorização de Uso de Imagem e Voz",
    "tipo": "Termo",
    "partes": "Inspira FM — Campinas × [AUTORIZANTE]",
    "texto": "Beneficiária: LIFE COMUNICAÇÃO LTDA. — INSPIRA FM — CAMPINAS, inscrita no CNPJ sob nº 53.090.596/0001-24, com sede na Rua Atibaia, nº 26, Nova Campinas, Campinas/SP, CEP 13.092-142, adiante denominada simplesmente EMISSORA.\n\nEu, [NOME COMPLETO], portador(a) do CPF nº [CPF], residente em [CIDADE/UF], AUTORIZO, de forma gratuita e por prazo indeterminado, a EMISSORA a captar, utilizar, editar e veicular minha imagem e minha voz em:\na) programação da rádio (ao vivo ou gravada);\nb) redes sociais, site e aplicativo da emissora;\nc) materiais institucionais e de divulgação, digitais ou impressos.\n\n1. A autorização abrange o material captado em [DESCREVER O CONTEXTO — ex.: entrevista no estúdio em DATA / cobertura do evento X].\n2. A utilização não gera qualquer obrigação de pagamento, vínculo empregatício ou exclusividade.\n3. A EMISSORA compromete-se a utilizar o material com respeito, sem distorcer o contexto das declarações.\n4. Esta autorização pode ser revogada a qualquer momento, por escrito, valendo a revogação apenas para novas veiculações.\n\n[CIDADE/UF], [DATA].\n\n\n_____________________________________\n[NOME COMPLETO] — Autorizante\n\n_____________________________________\nLIFE COMUNICAÇÃO LTDA. — INSPIRA FM — CAMPINAS"
  },
  "confidencialidade": {
    "nome": "Termo de confidencialidade (NDA)",
    "titulo": "Termo de Confidencialidade e Sigilo",
    "tipo": "Termo",
    "partes": "Inspira FM — Campinas × [PARTE RECEPTORA]",
    "texto": "REVELADORA: LIFE COMUNICAÇÃO LTDA. — INSPIRA FM — CAMPINAS, pessoa jurídica de direito privado com endereço na Rua Atibaia, nº 26, Nova Campinas, Campinas/SP, CEP 13.092-142, inscrita no CNPJ sob nº 53.090.596/0001-24, neste ato representada na forma de seu contrato social, adiante denominada simplesmente REVELADORA.\n\nRECEPTORA: [NOME COMPLETO / RAZÃO SOCIAL], inscrito(a) no CPF/CNPJ sob nº [DOCUMENTO], com endereço na [ENDEREÇO], adiante denominado(a) simplesmente RECEPTORA.\n\nCLÁUSULA PRIMEIRA — DO OBJETO\n1.1. Este termo regula a proteção das informações confidenciais compartilhadas pela REVELADORA com a RECEPTORA em razão de [MOTIVO — ex.: prestação de serviços, negociação de parceria, projeto].\n\nCLÁUSULA SEGUNDA — DAS INFORMAÇÕES CONFIDENCIAIS\n2.1. Consideram-se confidenciais dados comerciais, financeiros, de audiência, estratégias, contratos, folha, senhas e quaisquer informações internas não públicas, em qualquer formato.\n2.2. Não são confidenciais informações comprovadamente já públicas, ou de conhecimento prévio da RECEPTORA sem violação de dever de sigilo.\n\nCLÁUSULA TERCEIRA — DAS OBRIGAÇÕES\n3.1. A RECEPTORA compromete-se a não divulgar, copiar ou utilizar as informações para finalidade diversa do objeto, e a restringir o acesso apenas a quem delas necessite.\n3.2. A RECEPTORA observará a Lei Geral de Proteção de Dados (Lei nº 13.709/2018) quanto a dados pessoais eventualmente acessados.\n\nCLÁUSULA QUARTA — DO PRAZO\n4.1. As obrigações de sigilo vigoram durante a relação entre as partes e por [PRAZO — ex.: 5 (cinco) anos] após o seu término.\n\nCLÁUSULA QUINTA — DA PENALIDADE\n5.1. A violação sujeita a RECEPTORA à reparação integral das perdas e danos, sem prejuízo das medidas judiciais cabíveis.\n\nCLÁUSULA SEXTA — DO FORO\n6.1. Fica eleito o foro da Comarca de [FORO — ex.: Campinas/SP], com renúncia a qualquer outro.\n\n[CIDADE/UF], [DATA].\n\n\n_____________________________________\nLIFE COMUNICAÇÃO LTDA. — INSPIRA FM — CAMPINAS — REVELADORA\n\n_____________________________________\n[NOME COMPLETO / RAZÃO SOCIAL] — RECEPTORA"
  }
};
function jurInit(){
  if(!canRe()) return;
